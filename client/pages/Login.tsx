    ...
    <div className="min-h-screen bg-gradient-to-br from-valasys-gray-50 via-white to-valasys-orange/5 lg:grid lg:grid-cols-2 relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Mail
                      className={`absolute left-3 top-3 h-4 w-4 transition-colors duration-200 ${focusedField === "email" ? "text-valasys-orange" : "text-gray-400"}`}
                    />
                    <Input
                      id="email"
                      type="email"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Lock
                      className={`absolute left-3 top-3 h-4 w-4 transition-colors duration-200 ${focusedField === "password" ? "text-valasys-orange" : "text-gray-400"}`}
                    />
                    <Input
                      id="password"
                    ...
                    <button
                      ...
                      className="absolute right-3 top-3 h-4 w-4 text-gray-400 hover:text-valasys-orange transition-colors duration-200"
                    >
      ...
      <div className="hidden lg:flex relative bg-gradient-to-br from-valasys-orange/10 via-valasys-blue/10 to-valasys-green/10 backdrop-blur-sm">
        ...
        <div className="relative z-10 flex flex-col justify-center space-y-8 p-8 w-full">
          ...
          {/* Trust Badges */}
          <div
            className={`flex items-center justify-center flex-wrap gap-4 pt-6 border-t border-valasys-gray-200 transform transition-all duration-700 ${mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          ...
          >
            ...
            <div className="flex items-center space-x-2 hover:scale-105 transition-transform duration-300 cursor-pointer">
              <div className="p-2 bg-valasys-orange/10 rounded-full backdrop-blur-sm">
            ...
            <div className="flex items-center space-x-2 hover:scale-105 transition-transform duration-300 cursor-pointer">
              <div className="p-2 bg-valasys-gray-100 rounded-full backdrop-blur-sm">
